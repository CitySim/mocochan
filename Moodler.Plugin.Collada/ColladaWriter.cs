...
namespace Moodler.Plugin.Collada
{
	public class ColladaWriter : IExporter
	{
		...
		private void WriteAsset(XmlTextWriter doc)
		{
			...
			doc.WriteElementString("authoring_tool", "Moodler x.x.x.x; COLLADA Plugin x.x.x.x");
		...
		private void WriteVisualScenesLibrary(XmlTextWriter doc, Model model)
		{
			...
			doc.WriteAttributeString("name", "MoodlerScene");
